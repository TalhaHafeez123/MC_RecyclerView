...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Employees f3 = new Employees(4,"Martin",R.drawable.image3);
        Employees f4 = new Employees(5,"Charles", R.drawable.image2);
        Employees f5 = new Employees(6,"Oliver",R.drawable.image1);
        Employees f6 = new Employees(7,"Emma", R.drawable.image3);
        Employees f7 = new Employees(8,"Kate",R.drawable.image2);
        Employees f8 = new Employees(8,"Elizebeth",R.drawable.image4);
        Employees f9 = new Employees(8,"Rupenzel",R.drawable.image1);
        Employees f10 = new Employees(8,"Iris",R.drawable.image3);
